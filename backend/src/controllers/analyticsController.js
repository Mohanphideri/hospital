...
export const getOverview = async (req, res) => {
  try {
    // "Today" must mean today in the clinic's timezone (India), not the server's own -
    // otherwise this can over/undercount right around midnight if the server runs in UTC.
