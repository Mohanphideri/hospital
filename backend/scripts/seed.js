...
async function seed() {
  try {
    ...
    // "Not sure what's wrong" / walk-in consultation - no doctor schedule is
    // attached to this one on purpose. Patients booking into it skip the
    // time-slot picker entirely; a receptionist assigns a doctor + any time
    // afterwards from the front desk.
