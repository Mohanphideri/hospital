// Split out of ../Section.jsx (see that file's renderPatient usage) to keep Section.jsx a manageable size. All state lives in Section.jsx; this file receives everything it
          ...
          <DataCard title="Find a slot" subtitle="You don't choose a doctor — HeartStone assigns you whichever doctor is available for that department and time.">
            <div className="grid gap-5 md:grid-cols-2">
              ...
              <label className="space-y-2">
                ...
                <input type="date" value={selectedDate} min={new Date().toISOString().slice(0, 10)} onChange={e => {
