// Split out of ../Section.jsx (see that file's renderStaff usage) to keep Section.jsx a manageable size. All state lives in Section.jsx; this file receives everything it
          ...
          <form onSubmit={submitLeaveApplication} className="space-y-6 rounded-2xl border border-mist bg-white p-6 sm:p-8 shadow-sm">
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              <label className="space-y-2">
                ...
                <input type="date" value={leaveForm.fromDate} min={new Date().toISOString().slice(0, 10)} onChange={e => setLeaveForm(prev => ({
              ...prev,
              ...
              <label className="space-y-2">
                ...
                <input type="date" value={leaveForm.toDate} min={leaveForm.fromDate || new Date().toISOString().slice(0, 10)} onChange={e => setLeaveForm(prev => ({
              ...prev,
