// Split out of ../Section.jsx (see that file's renderMessages usage) to keep Section.jsx a manageable size. All state lives in Section.jsx; this file receives everything it
...
import { EmptyRow } from "../../components/DataCard";
