...
// Staff-only "forgot password" flow: email -> 4-digit OTP (Brevo) -> new
// password. Patients don't have passwords (phone OTP only), so this page is
// only linked from the staff login tab. OTP length is kept at 4 digits to
// match every other OTP flow in the project (login, ambulance booking).
