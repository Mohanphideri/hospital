...
// Shared shell for every public informational/legal page (About, Privacy
// Policy, FAQ, etc.) - a light editorial hero matching the rest of the site,
// an optional in-page "On this page" jump list for longer documents, and a
// closing "still have questions" band, instead of a bare title + paragraph
// dump.
export default function PublicPage({ title, eyebrow, updated, icon: Icon, intro, toc, children }) {
  return (
    <div className="min-h-screen bg-paper text-ink">
      ...
      {/* Closing CTA - present on every info/legal page so a dead-end
          document never leaves the visitor without a next step. */}
